...
namespace Blog.Core.AuthHelper
{
    ...
    public class JwtTokenAuth
    {
        ...
        private async Task<List<PermissionItem>> GetPermitionData()
        {
            ...
            {
                InfluxdbHelper.GetInstance().AddErrLog((int)SysComLogType.网关信息日志, "JwtTokenAuth.GetPermitionData", "apigateway", $"GetPermitionData.error",ee);
            }
        ...
        public bool CheckWhiteList(string url)
        {
            ...
            //string WhiteLists = _cache.Cof_GetICaching<string>("WhiteList", () => Appsettings.GetValue("WhiteList"), 10);
        ...
        public bool CheckBlackList(string url)
        {
            ...
            //string BlackLists = _cache.Cof_GetICaching<string>("BlackList", () => Appsettings.GetValue("BlackList"), 10);
            //string[] BlackList = BlackLists.Split(',');

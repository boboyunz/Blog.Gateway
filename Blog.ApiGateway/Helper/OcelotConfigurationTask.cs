...
namespace ApiGateway.Helper
{
    ...
    public class OcelotConfigListener : IListener
    {
        ...
        public void ReceiveConfigInfo(string configInfo)
        {
            ...
            InfluxdbHelper.GetInstance().AddInfoLog((int)SysComLogType.网关信息日志, "OcelotConfigListener", "apigateway", $"config={configInfo}");
        }
    }
    ...
    public class AppConfigListener : IListener
    {
        public void ReceiveConfigInfo(string configInfo)
        {
            ...
            InfluxdbHelper.GetInstance().AddInfoLog((int)SysComLogType.网关信息日志, "AppConfigListener", "apigateway", $"config={configInfo}");
